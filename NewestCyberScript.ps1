$files=$PSScriptRoot
$host.ui.RawUI.WindowTitle="Windows 10 Cyber Script - Cyb3rPatr!0t$"
...
function secPol{
	try{
		secedit.exe /configure /db secedit.sdb /cfg "$files\CyberLocalSecurityPolicy10.inf"
		#autoupdates
		...
		echo "Security Policy Has been Updated"
	}catch{
...
#Extra Menu
function extrMenu{
	$extrOption=read-host "`n`n1. Get File Hash`n2. NMAP IT`n3. `n4. `n5. `n6. `n`nYour Selection"
	switch($extrOption){
		0{clear;userMenu}
		1{fileHash}
		2{nmap}
